...
#define PORTD_PIN0_INIT  1
#define PORTD_PIN1_INIT  1
#define PORTD_PIN2_INIT  1
#define PORTD_PIN3_INIT  1
#define PORTD_PIN4_INIT  1
#define PORTD_PIN5_INIT  1
#define PORTD_PIN6_INIT  1
#define PORTD_PIN7_INIT  1
